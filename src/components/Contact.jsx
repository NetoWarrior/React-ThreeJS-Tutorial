...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setLoading(true);
    emailjs.send('service_2akxjx9', 'template_o2btd4v', {
      from_name: form.name,
      to_name: 'Fedrick',
      from_email: form.email,
      to_email: 'fedrickpereira123@gmail.com',
  ...
  return (
    <div
      className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-0 overflow-hidden"
    >
      <motion.div
